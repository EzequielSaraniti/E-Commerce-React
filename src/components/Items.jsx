...
export default function Items({ id, title, description, price, pictureUrl, stock }) {
    ...
    return (
        ...
        <div className='cardH zoom'>
            ...
            <Link className='btnDetalle' to={`/item/${id}`}>Ver detalle del producto <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-arrow-down-left-square" viewBox="0 0 16 16">
