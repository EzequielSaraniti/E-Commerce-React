  ...
  return (
    <div className='cardDetalles'>
      ...
      <div className='precioDetails'>
        ...
        {/* Stock restante */}
        {articulosAgregados === 0 && <p className='uDisp'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pin-angle" viewBox="0 0 16 16">
