...
export default function ItemCount({ stock, initial, onAdd, restar, sumar, cantSelect }) {
    ...
    return (
        <div className='centerCount'>
            ...
            <button type='button' className='btnAddCar' onClick={onAdd}><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
